...
# None of these may include spaces
...
export SSMPREFIX=loneworker # Prefix in various names
export APP=loneworker # Used for tags

# Everything below here should be in some sourced script; move it later.
# Parameters for cloud formation
export PARAMETERS="ParameterKey=bucketName,ParameterValue=${BUCKET_NAME} ParameterKey=environment,ParameterValue=${ENVIRONMENT} ParameterKey=ssmprefix,ParameterValue=${SSMPREFIX} ParameterKey=app,ParameterValue=${APP}"
